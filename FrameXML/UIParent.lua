...
UIPanelWindows["PlayerContainerFrame"] =	{ area = "left",	pushable = 0 };
...
function FramePositionDelegate:UpdateUIPanelPositions(currentFrame)
	...
	if ( frame ) then
		...
		if frame:GetName() == "SpellBookFrame" then
	...
	if ( frame ) then
		if ( CanShowCenterUIPanel(frame) ) then
			...
			if self:GetUIPanel("left") then
				if self:GetUIPanel("left"):GetName() == "SpellBookFrame" then
					centerOffset = centerOffset + 35
				end
			end
			if ( area ~= "center" ) then
				frame:ClearAllPoints();
...
function Model_OnUpdate(self, elapsedTime, rotationsPerSecond)
    ...
    ---// Gob model
    if ( _G["NobleButton_DressUp_UPPlus"]:GetButtonState() == "PUSHED" ) then
		NobleVar_DressUpZposition = NobleVar_DressUpZposition + 0.02;
        DressUpModel:SetPosition(NobleVar_DressUpXposition, NobleVar_DressUpYposition, NobleVar_DressUpZposition);
    end
    if ( _G["NobleButton_DressUp_DownMinus"]:GetButtonState() == "PUSHED" ) then
		NobleVar_DressUpZposition = NobleVar_DressUpZposition - 0.02;
        DressUpModel:SetPosition(NobleVar_DressUpXposition, NobleVar_DressUpYposition, NobleVar_DressUpZposition);
    end
    if ( _G["NobleButton_DressUp_Left"]:GetButtonState() == "PUSHED" ) then
		NobleVar_DressUpYposition = NobleVar_DressUpYposition - 0.02;
        DressUpModel:SetPosition(NobleVar_DressUpXposition, NobleVar_DressUpYposition, NobleVar_DressUpZposition);
    end
    if ( _G["NobleButton_DressUp_Right"]:GetButtonState() == "PUSHED" ) then
		NobleVar_DressUpYposition = NobleVar_DressUpYposition + 0.02;
        DressUpModel:SetPosition(NobleVar_DressUpXposition, NobleVar_DressUpYposition, NobleVar_DressUpZposition);
    end
    if ( _G["NobleButton_DressUp_SizePlus"]:GetButtonState() == "PUSHED" ) then
		NobleVar_DressUpXposition = NobleVar_DressUpXposition + 0.05;
        DressUpModel:SetPosition(NobleVar_DressUpXposition, NobleVar_DressUpYposition, NobleVar_DressUpZposition);
    end
    if ( _G["NobleButton_DressUp_SizeMinus"]:GetButtonState() == "PUSHED" ) then
		NobleVar_DressUpXposition = NobleVar_DressUpXposition - 0.05;
        DressUpModel:SetPosition(NobleVar_DressUpXposition, NobleVar_DressUpYposition, NobleVar_DressUpZposition);
	end
end
