...
--				ExhaustionLevelFillBar:SetPoint("TOPRIGHT", "MainMenuExpBar", "TOPRIGHT", 0, 0);
	...
	if ((event == "PLAYER_ENTERING_WORLD") or (event == "UPDATE_EXHAUSTION")) then
		...
		if (exhaustionStateID == 1) then
			MainMenuExpBar:SetStatusBarColor(0.24, 0.24, 0.75, 1.0);
			ExhaustionLevelFillBar:SetVertexColor(0.0, 0.39, 0.88, 0);
			ExhaustionTickHighlight:SetVertexColor(0.0, 0.39, 0);
		elseif (exhaustionStateID == 2) then
			MainMenuExpBar:SetStatusBarColor(0.24, 0.24, 0.75, 1.0);
			ExhaustionLevelFillBar:SetVertexColor(0.58, 0.0, 0.55, 0);
			ExhaustionTickHighlight:SetVertexColor(0.58, 0.0, 0);
		end
