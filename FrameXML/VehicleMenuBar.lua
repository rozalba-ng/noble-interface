...
function VehicleSeatIndicator_OnEvent(self, event, ...)
	...
	(event == "PLAYER_LOSES_VEHICLE_DATA" and arg1 == "player") ) then
        VehicleSeatIndicator.customVehicle = false;
		VehicleSeatIndicator_UnloadTextures();        
    elseif ( event == "CHAT_MSG_ADDON" ) then
        if ( arg4 == UnitName("player") and arg1 == "CUSTOM_VEHICLE_ENTER") then
            VehicleSeatIndicator.customVehicle = true;
            CustomVehicleSeatIndicator_SetUpVehicle(arg2);
        elseif ( arg4 == UnitName("player") and arg1 == "CUSTOM_VEHICLE_UPDATE") then
            CustomVehicleSeatIndicator_Update(arg2);
        end
	end
end
