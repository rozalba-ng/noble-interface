...
function MuteGossipSound(text)
if text then 
	if text == "TalkingHead" then
			SavedSFXVolume = select(1, GetCVarInfo("Sound_SFXVolume"))
			C_Timer:After(1.5, function() SetCVar("Sound_SFXVolume", SavedSFXVolume) end);
