...
GlueAmbienceTracks["VULPERA"] = "GlueScreenGoblin";
GlueAmbienceTracks["LIGHTFORGEDDRAENEI"] = "GlueScreenDraenei";
GlueAmbienceTracks["NIGHTELFN"] = "GlueScreenNightElf";
GlueAmbienceTracks["HUMANN"] = "GlueScreenHuman";
GlueAmbienceTracks["VOIDELF"] = "GlueScreenBloodElf";
GlueAmbienceTracks["PANDAREN"] = "GlueScreenGoblin";
GlueAmbienceTracks["WORGEN"] = "GlueScreenHuman";
GlueAmbienceTracks["NIGHTBORNE"] = "GlueScreenNightElf";
GlueAmbienceTracks["NAGA"] = "GlueScreenHuman";
GlueAmbienceTracks["BLOODELFN"] = "GlueScreenBloodElf";
GlueAmbienceTracks["UPRIGHT"] = "GlueScreenOrcTroll";
...
function SetBackgroundModel(model, name)
	if (strupper(name) == "ZANDALARITROLL") then
		name = "Troll";
	end
	if (strupper(name) == "DARKIRONDWARF") then
		name = "Dwarf";
	end
	if (strupper(name) == "VULPERA") then
		name = "Goblin";
	end
	if (strupper(name) == "LIGHTFORGEDDRAENEI") then
		name = "Draenei";
	end
	if (strupper(name) == "NIGHTELFN") then
		name = "Nightelf";
	end
	if (strupper(name) == "HUMANN") then
		name = "Human";
	end
	if (strupper(name) == "BLOODELFN") then
		name = "Bloodelf";
	end
	if (strupper(name) == "UPRIGHT") then
		name = "Orc";
	end
	if (strupper(name) == "VOIDELF") then
		name = "Bloodelf";
	end
	if (strupper(name) == "PANDAREN") then
		name = "Goblin";
	end
	if (strupper(name) == "WORGEN") then
		name = "Human";
	end
	if (strupper(name) == "NIGHTBORNE") then
		name = "Nightelf";
	end
	if (strupper(name) == "NAGA") then
		name = "Human";
	end
	if (strupper(name) == "GOBLIN") then
		name = "Goblin";
	end
